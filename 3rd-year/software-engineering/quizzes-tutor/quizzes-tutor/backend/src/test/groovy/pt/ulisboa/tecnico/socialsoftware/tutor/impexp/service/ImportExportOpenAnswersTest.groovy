...
@DataJpaTest
class ImportExportOpenAnswersTest extends SpockTest {
    def quizAnswer
    def questionAnswer
    ...
    def setup() {
        ...
        def answer = new OpenAnswer(questionAnswer, OPEN_ANSWER_1_CONTENT)
    ...
    def 'export and import answers'() {
        ...
        questionAnswerResult.getAnswerDetails().getAnswerRepresentation() == OPEN_ANSWER_1_CONTENT
    }

...
@DataJpaTest
class RemoveMultipleChoiceQuestionTest extends SpockTest {
    def question
    def optionOne
    def optionTwo
    def optionThree
    ...
    def setup() {
        ...
        optionOne.setQuestionDetails(questionDetails)
        optionRepository.save(optionOne)

        optionTwo = new Option()
        optionTwo.setContent(OPTION_2_CONTENT)
        optionTwo.setCorrect(true)
        optionTwo.setRelevance(1)
        optionTwo.setSequence(0)
        optionTwo.setQuestionDetails(questionDetails)
        optionRepository.save(optionTwo)

        optionThree = new Option()
        optionThree.setContent(OPTION_3_CONTENT)
        optionThree.setCorrect(false)
        optionThree.setRelevance(0)
        optionThree.setSequence(0)
        optionThree.setQuestionDetails(questionDetails)
        optionRepository.save(optionThree)

...
class FilterQuestionsByStudentModelTest extends SpockTest {
    ...
    def 'the user answered 4 questions' () {
        ...
        def listOfOptions1 = new ArrayList<>()
        listOfOptions1.add(option)
        questionAnswer.setAnswerDetails(new MultipleChoiceAnswer(questionAnswer, listOfOptions1))

        def listOfOptions2 = new ArrayList<>()
        listOfOptions2.add(option)
        questionAnswer = new QuestionAnswer(quizAnswer, quizQuestionFour, 10, 0)
        questionAnswer.setAnswerDetails(new MultipleChoiceAnswer(questionAnswer, listOfOptions2))

        def listOfOptions3 = new ArrayList<>()
        listOfOptions3.add(option)
        questionAnswer = new QuestionAnswer(quizAnswer, quizQuestionFive, 10, 0)
        questionAnswer.setAnswerDetails(new MultipleChoiceAnswer(questionAnswer, listOfOptions3))

        def listOfOptions4 = new ArrayList<>()
        listOfOptions4.add(option)
        questionAnswer = new QuestionAnswer(quizAnswer, quizQuestionSix, 10, 0)
        questionAnswer.setAnswerDetails(new MultipleChoiceAnswer(questionAnswer, listOfOptions4))
    ...
    def 'the user answered 5 questions' () {
        ...
        def listOfOptions5 = new ArrayList<>()
        listOfOptions5.add(option)
        questionAnswer = new QuestionAnswer(quizAnswer, quizQuestionSix, 10, 0)
        questionAnswer.setAnswerDetails(new MultipleChoiceAnswer(questionAnswer, listOfOptions5))

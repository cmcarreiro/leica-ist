...
class DiscussionFixtureSpockTest extends SpockTest {
    ...
    def defineBaseFixture() {
        ...
        def questionDetailsOptions = new ArrayList<OptionDto>()
        questionDetailsOptions.add(optionDto)
        questionDetailsOptions.add(optionDto2)

        questionDetails1.setListOfOptions(questionDetailsOptions)
        questionDetailsRepository.save(questionDetails1)
        questionRepository.save(question1)

        questionDetails2.setListOfOptions(questionDetailsOptions)
        ...
        def answerDetailsOptions = new ArrayList<Option>()
        answerDetailsOptions.add(optionRepository.findAll().get(0))
        ...
        def answerDetails2Options = new ArrayList<Option>()
        answerDetails2Options.add(optionRepository.findAll().get(0))
        def answerDetails2 = new MultipleChoiceAnswer(questionanswer, answerDetails2Options);

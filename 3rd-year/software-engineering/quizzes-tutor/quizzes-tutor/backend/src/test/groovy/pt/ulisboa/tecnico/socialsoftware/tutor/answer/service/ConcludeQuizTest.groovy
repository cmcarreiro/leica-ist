...
class ConcludeQuizTest extends SpockTest {
    ...
    def 'conclude quiz with answer, before conclusionDate'() {
        ...
        def multipleChoiceAnswerDetailsDto = new MultipleChoiceStatementAnswerDetailsDto()
        ArrayList<Integer> listOfOptionIds = new ArrayList<>()
        listOfOptionIds.add(optionOk.getId())
        multipleChoiceAnswerDetailsDto.setListOfOptionIds(listOfOptionIds)
        statementAnswerDto.setAnswerDetails(multipleChoiceAnswerDetailsDto)
        ...
        correctAnswerDto.getCorrectAnswerDetails().getListOfCorrectOptionIds()[0] == optionOk.getId()
    }

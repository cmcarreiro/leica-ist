...
class SpockTest extends Specification {
    ...
    public static final String OPEN_ANSWER_1_CONTENT = "Question Answer 1"
    public static final String OPEN_ANSWER_2_CONTENT = "Question Answer 2"
    public static final String OPEN_ANSWER_INV_CONTENT = ""

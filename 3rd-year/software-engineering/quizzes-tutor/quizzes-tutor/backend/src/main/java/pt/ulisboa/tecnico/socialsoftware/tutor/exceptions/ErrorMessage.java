...
public enum ErrorMessage {
    ...
    INVALID_CONTENT_FOR_ITEM("Invalid content for item"),
    INVALID_GROUP_FOR_ITEM("Invalid group for item"),
    ...
    INVALID_SEQUENCE_FOR_ITEM("Invalid sequence for item"),
    INVALID_SEQUENCE_FOR_QUESTION_ANSWER("Invalid sequence for question answer"),
    INVALID_RELEVANCE_FOR_OPTION("Invalid relevance for option"),
    ...
    ITEM_NOT_FOUND("Item not found with id %d"),
    ...
    QUESTION_ITEM_MISMATCH("Question %d does not have item %d"),
    ...
    NO_CORRECT_ITEM_COMBINATION("Question does not have a correct item combination"),
    ...
    AT_LEAST_ONE_ITEM_IN_GROUP_ONE_NEEDED("Group one in item combination question needs at least one item."),
    AT_LEAST_ONE_ITEM_IN_GROUP_TWO_NEEDED("Group two in item combination question needs at least one item."),
    AT_LEAST_ONE_CORRECT_OPTION_NEEDED("Questions need to have at least 1 correct option"),
    ANSWER_MUST_BE_PROVIDED("Open answer question must specify a correct answer example."),

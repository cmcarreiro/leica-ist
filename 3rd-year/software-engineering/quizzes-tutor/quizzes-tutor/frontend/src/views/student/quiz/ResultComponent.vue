...
import OpenAnswer from '@/components/open-answer/OpenAnswer.vue';
import ItemCombinationAnswerResult from '@/components/item-combination/ItemCombinationAnswerResult.vue';
...
@Component({
  components: {
    ...
    item_combination: ItemCombinationAnswerResult
  }
})

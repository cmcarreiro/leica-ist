...
void fir::frame_size_calculator::do_print_node(fir::print_node *const node, int lvl) {
  // EMPTY
}
void fir::frame_size_calculator::do_input_node(fir::input_node *const node, int lvl) {
  // EMPTY
}
...
void fir::frame_size_calculator::do_nullptr_node(fir::nullptr_node *const node, int lvl) {
  // EMPTY
}
...
void fir::frame_size_calculator::do_while_finally_node(fir::while_finally_node *const node, int lvl) {
  // EMPTY
}
...
void fir::frame_size_calculator::do_prologue_node(fir::prologue_node *const node, int lvl) {

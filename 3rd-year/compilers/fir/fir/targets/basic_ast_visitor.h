#ifndef __FIR_BASIC_AST_VISITOR_H__
#define __FIR_BASIC_AST_VISITOR_H__
...
private:
  ...
  std::shared_ptr<fir::symbol> _new_symbol;
...
public:
  std::shared_ptr<fir::symbol> new_symbol() {
    return _new_symbol;
  }

  void set_new_symbol(std::shared_ptr<fir::symbol> symbol) {
    _new_symbol = symbol;
  }
